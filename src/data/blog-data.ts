...
export const BLOG_POSTS: BlogPost[] = [
...

  {
    ...
    excerptHi: "Ranchi में pancreatitis (pancreas की सूजन) के specialist: Dr. Akhilesh Yadav — DM Gastroenterology — Orchid Medical Centre. Acute और chronic pancreatitis का complete इलाज.",
...

  {
    ...
    excerptHi: "Ranchi में digestive system के specialist: Dr. Akhilesh Yadav — DM Gastroenterology — Orchid Medical Centre. हर प्रकार की पाचन समस्याओं का सम्पूर्ण इलाज.",
...

  {
    ...
    titleHi: "Colonoscopy Cost Ranchi — खर्चा, Preparation और डॉक्टर | Dr. Akhilesh Yadav",
    titleEn: "Colonoscopy Cost in Ranchi — Price, Preparation & Expert Care | Dr. Akhilesh Yadav",
    excerptHi: "Ranchi में colonoscopy का खर्चा कितना है? Dr. Akhilesh Yadav — Orchid Medical Centre — में affordable colonoscopy, complete preparation guide और expert colonoscopist.",
...

  {
    ...
    excerptHi: "Ranchi में EUS (Endoscopic Ultrasound) — advanced GI diagnostic procedure — Dr. Akhilesh Yadav करते हैं Orchid Medical Centre में. Pancreas, bile duct, submucosal lesions.",
...

  {
    ...
    titleHi: "Liver Biopsy Ranchi — Procedure, Cost और कब ज़रूरी है | Dr. Akhilesh Yadav",
    titleEn: "Liver Biopsy in Ranchi — Procedure, Cost & When Needed | Dr. Akhilesh Yadav",
    excerptHi: "Ranchi में liver biopsy कब ज़रूरी है और कैसे होती है? Dr. Akhilesh Yadav — Orchid Medical Centre — में liver biopsy की पूरी guide और FibroScan alternative.",
...

  {
    ...
    excerptHi: "Ranchi में colon polyp removal (colonoscopic polypectomy) — Dr. Akhilesh Yadav — Orchid Medical Centre में. Cancer होने से पहले polyp removal कैसे cancer रोकती है — guide.",
