...
export const DIET_DATA: DietData[] = [
  ...
  {
    slug:       "liver-detox",
    titleEn:    "Liver Detox Foods — Fact vs Myth",
    titleHi:    "Liver Detox Hindi Tips — Sach aur Jhooth",
    metaTitle:  "Liver Detox Tips Hindi | Dr. Akhilesh Yadav Ranchi",
    metaDesc:   "Liver detox facts and myths in Hindi. What actually helps your liver vs what's a scam. Download free guide from Dr. Akhilesh, DM Gastro, Ranchi.",
    condition:  "Liver Health",
    conditionHi:"Liver Health",
    heroLine:   "Your liver detoxes itself — but these foods help it along",
    heroLineHi: "Aapka liver khud detox karta hai — par kuch khane mein madad karte hain",
    intro:      "\"Liver detox\" teas and juices are marketing myths. The liver detoxes 24/7 on its own. But certain foods reduce liver stress and support liver enzyme recovery.",
    introHi:    "\"Liver detox\" waali chai aur juice marketing myth hain. Liver 24/7 khud detox karta hai. Lekin kuch khaane liver ke stress ko kam karte hain aur liver enzymes ko recover karne mein madad dete hain.",
    eat: {
