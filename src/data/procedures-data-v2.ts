...
function getTemplateData(slug: string, title: string, hindiTitle: string): ProcedureDataV2 {
  return {
    ...
    title,
    hindiTitle,
    metaTitle: `${title} Procedure in Ranchi | Dr. Akhilesh Yadav`,
    metaDescription: `Get expert, painless ${title} procedure in Ranchi at Orchid Medical Centre by senior gastroenterologist Dr. Akhilesh Yadav, DM Gastroenterology.`,
