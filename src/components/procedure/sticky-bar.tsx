...
export default function StickyBar({ title }: StickyBarProps) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-muted text-[10px] uppercase font-semibold font-sans mt-1">Consultation &amp; Care</p>
          </div>
        </div>

        {/* Right Actions (Stripe/Apple Style Grouped CTAs) */}
