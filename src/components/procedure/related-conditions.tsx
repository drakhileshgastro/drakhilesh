      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center mb-12">
          ...
          <p className="font-sans text-muted text-base mt-2">
            Conditions diagnosed or managed via this procedure.
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-4xl mx-auto">
          {list.map((cond, idx) => (
            ...
            >
              <div>
                <span className="text-xs text-primary font-sans font-bold uppercase tracking-wider block">Clinical Condition</span>
